        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-8" align="center">
                    ...
                    <h5 class="mt-5"> FOOTER SETTİNGS </h5>

                    <form method="POST" action="updateFooter" enctype="multipart/form-data">

                        <div class="form-group mt-3">

                            <input class="mb-5" type="text" name="facebook" placeholder="facebook" />

                            <br />

                            <input type="text" class="mb-3" name="gismap" placeholder="gismap" />
